...
-- AlterTable: vehicles add tracker_device_id
ALTER TABLE "vehicles" ADD COLUMN "tracker_device_id" UUID;
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_tracker_device_id_key" UNIQUE ("tracker_device_id");
ALTER TABLE "vehicles" ADD CONSTRAINT "vehicles_tracker_device_id_fkey" FOREIGN KEY ("tracker_device_id") REFERENCES "tracker_devices"("id") ON DELETE SET NULL ON UPDATE CASCADE;
