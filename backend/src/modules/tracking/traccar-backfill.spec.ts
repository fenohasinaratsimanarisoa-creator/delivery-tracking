...
const backfillPositions = [
  { id: 1, deviceId: DEVICE_ID, latitude: -18.87, longitude: 47.52, speed: 10, course: 90, altitude: 0, accuracy: 10, valid: true, fixTime: P1_TIME, deviceTime: P1_TIME },
  { id: 2, deviceId: DEVICE_ID, latitude: -18.88, longitude: 47.53, speed: 12, course: 100, altitude: 0, accuracy: 10, valid: true, fixTime: P2_TIME, deviceTime: P2_TIME },
];
...
describe('TraccarBridgeService — performBackfill déduplication', () => {
  ...
  beforeEach(() => {
    ...
    const config = { get: jest.fn((key: string, d?: string) => {
      const m: Record<string, string> = { TRACCAR_URL: 'http://traccar-test:8082', TRACCAR_USER: 't', TRACCAR_PASSWORD: 't' };
    ...
    mockPrisma.vehicle.findMany.mockResolvedValue([
      { id: VEHICLE_ID, traccarDeviceId: String(DEVICE_ID), companyId: 'c1', driver: { id: DRIVER_ID } },
    ]);
